      ...
      >
        ...
        <div className="px-6 py-4 bg-[#0D1B2A] border-b-2 border-[#A07828] flex items-center justify-between shrink-0">
          ...
          <div className="flex items-center gap-3">
            {/* View Mode Toggle */}
            <div className="hidden sm:flex items-center bg-white/10 rounded-sm p-0.5 border border-white/15 text-xs">
              <button
                type="button"
                onClick={() => setActiveTab('document')}
                className={`px-3 py-1 rounded-xs transition-colors font-medium cursor-pointer ${
                  activeTab === 'document' ? 'bg-[#A07828] text-white' : 'text-white/70 hover:text-white'
                }`}
              >
                Read Online
              </button>
              <button
                ...
                className={`px-3 py-1 rounded-xs transition-colors font-medium cursor-pointer ${
                  activeTab === 'pdf' ? 'bg-[#A07828] text-white' : 'text-white/70 hover:text-white'
                }`}
              >
                PDF View
              </button>
            ...
            <button
              onClick={onClose}
              className="p-1.5 rounded-sm text-white/70 hover:text-white hover:bg-white/10 transition-colors cursor-pointer"
              ...
              >
                <div className="p-10 text-center flex flex-col items-center justify-center h-full gap-4">
                  ...
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="px-6 py-2.5 bg-[#A07828] text-white rounded-sm font-semibold text-xs uppercase tracking-wider"
                  >
